...
| Chat | `chat.go` | Enter=send, ^J=newline, Esc=command mode, Del=delete right, Alt+←/→=word nav. Command: c=complete, d=delete, e=edit, f=files, g=diff, m=memory, r=refresh, s=stop, S=summarize, t=schedule, x=shell |
